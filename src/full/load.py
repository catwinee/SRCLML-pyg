...
def load_from_json(
    ...
    for entry in app_entries:
        ...
        for item in entry['related_apis']:
            ...
            if api in api_mapping.keys():
                ...
                ground_truth[app_index].add(api_index)
                # description[app_index] = encoder(item['description'])
            else:
    ...
    return (
        app_invoke_api_subgraph,
        app_has_tag_subgraph,
        api_has_tag_subgraph,
        ground_truth,
        description
    )